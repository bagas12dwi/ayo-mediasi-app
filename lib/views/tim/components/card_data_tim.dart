...
class CardDataTim extends StatelessWidget {
  const CardDataTim({super.key, required this.nama, required this.tanggal, required this.email, required this.phone, required this.profilPath});
  final String nama;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      const Icon(Icons.phone_outlined, color: kLight,),
                      SizedBox(width: 10.h,),
                      Text(
                        phone,
                        style: TextStyle(
